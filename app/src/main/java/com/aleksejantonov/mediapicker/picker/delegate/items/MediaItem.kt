 ...
 * @property selected - picker view attribute
 */
data class MediaItem(
    ...
    override fun isTheSame(other: DiffListItem): Boolean = other is MediaItem
            && other.uniqueId == this.uniqueId

    override fun isContentTheSame(other: DiffListItem): Boolean = other is MediaItem
            && this == other
}